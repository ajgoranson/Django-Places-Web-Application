...
class TestHomePage(TestCase):
    ...
    def test_home_page_shows_empty_list(self):
        ...
        self.assertContains(response, 'You have no places in your wishlsit.')

class TestWishList(TestCase):
    fixtures = ['test_places']

    def test_wishlist_contains_not_visisted_place(self):
...
class TestVisitedPage(TestCase):
    ...
    def test_visited_page_shows_empty_list(self):
...
class VisitedList(TestCase):
    ...
    def test_visited_list_shows_visisted_places(self):
        response = self.client.get(reverse('places_visited'))
        self.assertTemplateUsed(response, 'travel_wishlist/visited.html')
...
class TestVisitPlace(TestCase):
    ...
    def test_non_Existent_place(self):
        visit_nonexistent_place_url = reverse('place_was_visited', args=(1234134, ))
